...
-   all types:
    ...
    -   allowed_values (character or list): either a list of allowed strings or a regular expression (see regular expression guide below)
    -   forbidden_values (character or list): either a list of forbidden strings or a regular expression
